                ...
                <div class="panel-body">
                    ...
                    if (isset($_GET['tipo'])) {
                        ...
                        if ($_GET['tipo'] == "edit") {
                            ...
                            $select_editar = "SELECT * FROM depmidia WHERE depmidia_id = $id_depmidia";
                            $executa_select_editar = mysql_query($select_editar)or die(mysql_error());
                            $linha_editar = mysql_fetch_array($executa_select_editar);
                            ?>
                            <form role="form" action="php/update_depmidia.php" method="POST" enctype='multipart/form-data'>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">LINK da MATÉRIA</label>
                                    <input value="<?php echo $linha_editar['link']; ?>" type="text" name="link" class="form-control tooltips" data-placement="top" data-original-title="Colque aqui o link do site de onde a matéria foi tirada" value="http://">
                                </div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">https://www.youtube.com/watch?v=</span>
                                        <input value="<?php echo $linha_editar['codigo']; ?>" type="text" name="codigo" class="form-control tooltips" data-placement="top" data-original-title="Poste o vídeo no youtube, copie o código de 11 dígitos gerado no link do vídeo após o sinal de igual (=), conforme o modelo abaixo" placeholder="1xq0gD-DIoc">
                                    </div>
                                </div>
                                <br/>
                                <br/>
