...
<div id="conteudo" >
    <a href="<?php echo base_url(); ?>index.php?reuniao/adicionar">
        <button style="margin-left: -325px; margin-top: 20px;" type="button" class="btn btn-success">+ Adicionar Reunião</button>
    </a>
