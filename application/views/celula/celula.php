...
<div id="conteudo" >
    <a href="<?php echo base_url(); ?>index.php?celula/adicionar">
        <button style="margin-left: -325px; margin-top: 20px;" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Adicionar Célula</button>
    </a>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <table style='font-size: 13px;' class="display table table-bordered table-striped" id="example">
                                <thead>
                                    <tr>
...
<script src="<?php echo base_url(); ?>template/js/DT_bootstrap.js" type="text/javascript"></script>
