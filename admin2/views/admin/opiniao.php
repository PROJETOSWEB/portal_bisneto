<div class="page page-table" data-ng-controller="ListaComprasController">
	<br/><br/>
    <a href="#/opiniao_adc"><button class="btn btn-primary"><span class="glyphicon glyphicon-plus">
            </span> OPINIÃO</button>
    </a>
    ...
    <section class="panel panel-default table-dynamic">
        ...
        <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> OPINIÃO</strong></div>
