<div class="page page-table" data-ng-controller="ListaComprasController">
	<br/><br/>
    <a href="#/salaimprensa_adc"><button class="btn btn-primary"><span class="glyphicon glyphicon-plus">
            </span> ARQUIVO</button>
    </a>
    ...
    <section class="panel panel-default table-dynamic">
        ...
        <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> SALA DE IMPRENSA</strong></div>
        ...
        <div class="table-filters">
            <div class="row">
                <div class="col-sm-4 col-xs-6">
                    <form>
                        <input type="text"
                               placeholder="procurando pelo arquivo..."
                               class="form-control"
