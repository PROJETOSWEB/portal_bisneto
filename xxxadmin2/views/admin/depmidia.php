<div class="page page-table" data-ng-controller="ListaComprasController">
	<br/><br/>
    <a href="#/depmidia_adc"><button class="btn btn-primary"><span class="glyphicon glyphicon-plus">
            </span> MÍDIA</button>
    </a>
    ...
    <section class="panel panel-default table-dynamic">
        ...
        <div class="panel-heading"><strong><span class="glyphicon glyphicon-th"></span> DEPUTADO NA MÍDIA</strong></div>
